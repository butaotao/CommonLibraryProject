...
public class SwipeListView extends PullToRefreshAdapterViewBase<SwipeMenuListView> {
	...
	public SwipeListView(Context context, Mode mode) {
		super(context, mode);

	}

	public SwipeListView(Context context, Mode mode, AnimationStyle style) {
	...
	protected SwipeMenuListView createListView(Context context,
			AttributeSet attrs) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(SwipeListView.this, deltaX, scrollX,
