...
public class FlowLayout extends ViewGroup {
	...
	public void setOnTagLongClickListener(OnTagLongClickListener listener) {
		mOnTagLongClickListener = listener;
	}
		...
		child.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				if (mOnTagLongClickListener != null) {
					mOnTagLongClickListener.onLongClick(v);
				}
				return true;
			}
		});
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		Log.e("yehj", "sizeWidth = " + sizeWidth);
		Log.e("yehj", "sizeHeight = " + sizeHeight);
