...
public class QiniuUploadTask  {
    ...
    private class MakeTokenRequest extends DCommonRequest {
...
//                    String url=QiNiuUtils.getFileUrl(bucket, key);
        ...
        UploadOptions opts=new UploadOptions(null, null, false, new UpProgressHandler() {
            @Override
            public void progress(String s, double v) {
                mListener.onFileUploadProgress(v);
            }
