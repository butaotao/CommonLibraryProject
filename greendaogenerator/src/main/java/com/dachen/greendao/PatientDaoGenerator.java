 ...
 * @author Markus
 */
public class PatientDaoGenerator {

    public static void main(String[] args) throws Exception {
        Schema schema = new Schema(3, "com.dachen.dgrouppatient.db");

        //添加Note对象的Schema，会生成针对Note的数据库相关代码
        addNote(schema);

        new DaoGenerator().generateAll(schema, "C://Users//Administrator//Desktop/demo");
    }
